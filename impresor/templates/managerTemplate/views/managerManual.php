...
<div id="flexwarper">
    <div id="topPanel" class="manualPanel">
        ...
        <div id="content-ready" class="container-full">

        </div>
    </div>
    <div id="bottomPanel" class="manualPanel">
        <div id="contentheader" class="container-full">
            <div class="row" style="margin-right: 18px;">
                <div class="col-xs-1 text-center">Nº Pedido</div>
                <div class="col-xs-2 text-center">Nombre</div>
        ...
        <div id="content-queue" class="container-full">
            ...
            <div id="summaryModalBody" class="modal-body">
                <div id="summaryModalTableHead" class="container-fluid">
                    <div class='row   text-center'>
                        ...
                        <div class="col-xs-1">Impresora</div>
            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button id="summaryModalConfigAllBtn" type="button" class="pull-right btn btn-default btn-lg">Configurar Todos <span class="glyphicon glyphicon-cog" aria-hidden="true"></span></button>
...
<div id="editDocumentsModal" class="modal fade" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editDocumentsModalTitle" >
                    Opciones
                </h4>
            </div>
            <div id="editDocumentsModalBody" class="modal-body">
                <p>SELECCIONE UNA IMPRESORA</p>
                <div id="editDocumentsModalPrinterSelector" class="container"></div>
                <div id="editDocumentsModalLoadingDiv" class="loadingDiv"><span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span></div>
                
            </div><!--finmodal edit body-->
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-3">
                            <button id="editDocumentsModalAcceptButton" type="button" class="btn btn-success btn-lg  pull-left">Guardar</button>
                        </div>
                        <div class="col-xs-6 text-center">

                        </div>
                        <div class="col-xs-3">
                            <button id="editDocumentsModalCancelButton" type="button" class="btn btn-danger btn-lg pull-right ">Cancelar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="templates" style="visibility: hidden">
    <div id="templatesummaryrow">
        <div class='row summaryrow text-center' id='jbocode'>
            ...
            <div class="col-xs-1 minicelda hiddenfornotfirstingroup"><span>jbopageRange</span></div>
            ...
            <div class="col-xs-1 hiddenfornotfirstingroup" id="statusjbocode">
                <span class="statusicon statusjbostatus"></span>
            </div>
            <div class="col-xs-1 hiddenfornotfirstingroup" optionindex="jboindex"><span id="printerjbocode" >jboprinterName</span></div>

            <div class="col-xs-1 configbutton jboconfigallowedclass hiddenfornotfirstingroup" id="configjbocode" optionindex="jboindex">
                <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
            </div>
        </div>
    </div><!-- fin template summaryrow-->
    ...
    <!--template spinner-->
    <div id="templatespinner">
            <span class="templatespinner glyphicon glyphicon-refresh glyphicon-refresh-animate"></span>
    </div>
<!--fin template spinner-->
    ...
    <div id="templatePricePanel" >
        <div id="pricepaneljbopricepanelid" class="pricepanel panel panel-default">
            ...
            <div class="panel-body panelbodyvalues"> 
                <div class="row">
    ...
    <div id="templateJobRow">
        <div class="row documentrow closed jbocancelClass" id="jboid">
            ...
            <div class="col-xs-1 text-center"><span class="btn btn-primary glyphicon glyphicon-print jboprintButtonClass" idJob="jboid" id="printjboid"></span></div>
        </div>
    </div>
    <!-- fin pricerowtemplate-->
</div>
...
<script>
    var controller = new managerManualCore();
</script>
<script>
